...
#undef unix
  ...
  N_LIB_PRIVATE N_NIMCALL(void, test01__test_2)(void);
...
N_LIB_PRIVATE N_NIMCALL(void, test01__test_2)(void) {
	nimfr_("test01", "/home/se0r12/Atcoder/AtCoder_Beginners_Selection/ABC088B/tests/nim/test.nim");
	nimln_(7, "/home/se0r12/Atcoder/AtCoder_Beginners_Selection/ABC088B/tests/nim/test.nim");
	main__OOZOOZmain_4();
	popFrame();
}
static N_INLINE(void, initStackBottomWith)(void* locals) {
...
N_LIB_PRIVATE N_NIMCALL(void, NimMainModule)(void) {
{
	nimfr_("test", "/home/se0r12/Atcoder/AtCoder_Beginners_Selection/ABC088B/tests/nim/test.nim");
	nimln_(10, "/home/se0r12/Atcoder/AtCoder_Beginners_Selection/ABC088B/tests/nim/test.nim");
	test01__test_2();
	popFrame();
}
}
